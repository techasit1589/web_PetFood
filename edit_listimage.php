                            ...
                            while ($data = $result->fetch_object()) {
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form name="edit"  method="post" action="upimage_adimid.php?id=<?php echo $_GET['id']; ?>&link=<?php echo $_GET['link']; ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" required name="name"  class="form-control" value=<?php echo $NameProduct; ?> readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="text" class="text-dark">รูปสินค้า</label><br>
                                                <input type="file" class="file"  name="image" placeholder="รูป" value="<?php echo $image; ?>" required >
                                            </div>
                                            <div class="form-group">
