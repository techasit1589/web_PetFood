...
<html lang="en">
    ...
    <body>
        ...
        if ($action == 'order') {
            ...
            echo "<div class=\"alert alert-danger\">โปรดส่งสลิปที่รายการสั่งซื้อไปที่ <a href='order_List.php'>รายการสั้งซื้อ</a></div>";
        }
        if ($action == 'orderfail') {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            ...
                            <a href="productview_ed.php?sel=1">ดูรายการอาหารทั้งหมด  <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    ...
                    while ($meResult = mysqli_fetch_assoc($meQuery)) {
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="product-item">
                                ...
                                ?>
                                <img src="images/<?php echo $meResult['image']; ?>" style="margin-left:35%; color: red;">
                                <div class="down-content">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="card-footer  border-top-0 bg-transparent">
                                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="updatecart.php?itemId=<?php echo $meResult['ProductID']; ?>">หยิบใส่ตะกร้า</a></div>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
